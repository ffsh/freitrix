...
class Media:
    ...
    def delete_cache_date(self, timestamp):
        r = requests.post('http://localhost:8008/_synapse/admin/v1/purge_media_cache?before_ts={}'.format(timestamp), headers=self.headers)
